...
async function loginAdmin() {
    ...
    try {
        ...
        if (!res1.ok || typeof data1.enc_k !== 'string' || !data1.enc_k.trim().startsWith('{')) {
            showMessage('Compte ancien non compatible P-256. Veuillez vous reinscrire.', 'error');
            return;
        }
